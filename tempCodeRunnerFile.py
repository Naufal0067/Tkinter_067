...
root.configure(bg="#2aff00")

# Membuat label
judul_label = tk.Label(root, text="Aplikasi Prediksi Prodi Pilihan", font=("Arial", 10, "bold"), bg="#ffd800")
...
hasil_label = tk.Label(root, text="", font=("Arial", 10, "italic", "bold"), fg="yellow", bg="#f0f0f0")
